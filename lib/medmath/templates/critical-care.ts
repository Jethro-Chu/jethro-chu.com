  ...
  },
  {
    ...
    generate: (rng) => {
      ...
      return {
        ...
        expectedAnswer: data.doseMcgKgMin,
  ...
  },
  {
    ...
    generate: (rng) => {
      ...
      return {
        ...
        expectedAnswer: data.doseMcgMin,
        expectedUnit: "mcg/min",
        roundingMode: "tenth",
        roundingInstruction: "State exact number or round to nearest tenth.",
        tolerance: 0.05,
  ...
  },
  {
    ...
    generate: (rng) => {
      ...
      return {
        ...
        expectedAnswer: data.rateIncrementMlHr,
        expectedUnit: "mL/hr",
        roundingMode: "tenth",
        roundingInstruction: "Round to nearest tenth.",
        tolerance: 0.1,
  ...
  },
  {
    ...
    generate: (rng) => {
      ...
      return {
        ...
        expectedAnswer: data.doseMcgKgHr,
        expectedUnit: "mcg/kg/hr",
        roundingMode: "tenth",
        roundingInstruction: "Round to nearest tenth.",
        tolerance: 0.05,
        hints: [
