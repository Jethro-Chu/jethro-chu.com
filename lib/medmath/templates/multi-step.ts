  ...
  },
  {
    ...
    generate: (rng) => {
      ...
      return {
        ...
        expectedAnswer: data.volDrawnMl,
        expectedUnit: "mL",
        roundingMode: "tenth",
        roundingInstruction: "Round to nearest tenth.",
        tolerance: 0.05,
  ...
  },
  {
    ...
    generate: (rng) => {
      ...
      return {
        ...
        expectedAnswer: data.runTimeHours,
        expectedUnit: "hours",
        roundingMode: "whole",
  ...
  },
  {
    ...
    generate: (rng) => {
      ...
      return {
        ...
        expectedAnswer: data.durationMinutes,
