  ...
  },
  {
    ...
    generate: (rng) => {
      ...
      return {
        ...
        correctAnswer: data.dailyDose,
        answerUnit: data.unit,
        answerPrecision: 0,
        roundingInstruction: "State whole number.",
        hints: [
